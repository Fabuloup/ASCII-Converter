...
| --------------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------------------- |
| ![Basic image to ASCII conversion](images/screenshot_ascii.png) | ![Image to ASCII with outline detection](images/screenshot_both.png) | ![Custom charset for conversion](images/screenshot_charset.png) |
